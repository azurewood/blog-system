...
export default function ShareButtons({ title, url, description }: ShareButtonsProps) {
  ...
  // Use window.location.href only after mount to avoid hydration mismatch
  ...
  return (
    <div className="flex flex-wrap items-center gap-3">
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="flex items-center justify-center w-10 h-10 rounded-full bg-[#1877F2] text-white hover:bg-[#166fe5] transition-colors"
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="flex items-center justify-center w-10 h-10 rounded-full bg-[#FF4500] text-white hover:bg-[#e03d00] transition-colors"
